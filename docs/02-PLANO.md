# Plano de Implementação — 8 Fases (Histórico)

> 📜 **Documento histórico.** Descreve o plano de rewrite faseado que guiou o desenvolvimento.
> F1–F7b concluídos. F8 parcial. O código atual está no `src/`.
> Para o estado atual, veja [`README.md`](../README.md) e [`01-ARQUITETURA.md`](./01-ARQUITETURA.md).
...
| Fase | Status | Notas |
|------|--------|-------|
| **F1** Foundation | ✅ Completo | |
| **F2** Domain + Ports | ✅ Completo | EventBus removido (dead code) |
| **F3** OV Adapter | ✅ Completo | |
| **F4** Operations | ✅ Completo | |
| **F5** Tools + Commands | ✅ Completo | 6 tools + 8 commands |
...
▼                                      │  │   │    │    │     │   │
┌─ F8: Features ────────────────────┐  │  │   │    │    │     │   │
│ (GraphExpander ✅, restante pend.) │  │  │   │    │    │     │   │
▼                                    ▼  ▼   ▼    ▼    ▼     ▼   ▼
┌──────────────────────────────────────────────────────────────────┐
│                        Release v1.0 (próximo)                    │
└──────────────────────────────────────────────────────────────────┘
```
...
| **F2** Domain + Ports | 16/jun | 26/jun | 9 | Ports definidas |
