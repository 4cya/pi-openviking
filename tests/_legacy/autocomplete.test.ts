...
import { createAutocompleteProvider, invalidateCache, parentUri } from "../../src/_legacy/autocomplete/autocomplete";
import type { FsClient } from "../../src/_legacy/ov-client/types";
