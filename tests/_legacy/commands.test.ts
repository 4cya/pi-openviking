...
import { COMMANDS } from "../../src/_legacy/bootstrap";
import { createMockClient, createMockSessionSync } from "./mocks";
import { RuntimeDeps } from "../../src/_legacy/bootstrap/runtime";
...
function registerAll(pi: ReturnType<typeof createMockPi>, overrides?: {
  ...
  autoRecallState?: { enabled: boolean; lastInjectedItems: import("../../src/_legacy/auto-recall/recall-curator").RecallItem[] };
}) {
...
describe("COMMANDS registry", () => {
  ...
  describe("/ov-recall", () => {
    test("toggles state", async () => {
      const autoRecallState = { enabled: true, lastInjectedItems: [] as import("../../src/_legacy/auto-recall/recall-curator").RecallItem[] };
      const pi = createMockPi();
    ...
    test("shows status", async () => {
      const autoRecallState = { enabled: false, lastInjectedItems: [] as import("../../src/_legacy/auto-recall/recall-curator").RecallItem[] };
      const pi = createMockPi();
      registerAll(pi, { autoRecallState });
      const cmd = pi.getCommand("ov-recall");
      const ctx = createMockCmdCtx();
